...
type CaseStudyProps = {
  ...
  /** When false, only the project card is shown (avoids repeated section headings). */
...
export default function CaseStudySection({
  ...
  imageAlt = "FX Acoustics commercial acoustic installation project",
  cardTitle = "Corporate Office Acoustic Retrofit",
  cardDescription = `A complete acoustic overhaul of a 50,000 sq ft corporate headquarters,
        ...
        >
          ...
          <FadeIn direction="up" className="w-full lg:w-1/2">
            {showIntroHeader ? (
              ...
              <h2 className="text-[20px] sm:text-[22px] lg:text-[24px] axiforma font-bold mb-3 text-gray-900">
                {cardTitle}
              </h2>
            )}
