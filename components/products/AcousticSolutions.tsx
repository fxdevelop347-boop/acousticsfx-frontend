...
interface AcousticSolutionsProps {
  /** Category slug from route /products/[category] — products and tabs are driven by backend categories. */
  categorySlug: string;
}

export default async function AcousticSolutions({ categorySlug }: AcousticSolutionsProps) {
  ...
  return (
    <section className="w-full bg-white">
      <div className="px-[24px] sm:px-[40px] md:px-[60px] lg:px-[100px] py-[60px] sm:py-[80px] lg:py-[100px]">
        ...
        {/* Top Tabs — dynamic from backend /api/products/categories */}
        ...
        {/* Heading — category name from backend */}
