...
export default function TrustedBySection() {
  ...
  return (
    <section className="px-4 sm:px-[40px] lg:px-[100px] py-10 sm:py-[80px] lg:py-[100px] bg-white text-center">

      <FadeIn direction="up">
        <h2 className="text-[1.25rem] sm:text-[34px] lg:text-[40px] font-bold text-[#111] mb-2 sm:mb-4 poppins leading-snug">
          {val(content, "contact.trustedBy.title")}
        </h2>

        <p className="text-gray-500 max-w-2xl worksans-font font-normal text-sm sm:text-[18px] lg:text-[20px] mx-auto mb-6 sm:mb-12 lg:mb-14 leading-relaxed">
      ...
      <div className="overflow-hidden w-full">
        <div className="flex w-max animate-marquee-left items-center gap-5 sm:gap-10 lg:gap-12">
...
function LogoItem({ src, alt }: { src: string; alt: string }) {
  return (
    <div className="flex items-center justify-center transition relative h-10 sm:h-14 lg:h-16 w-[100px] sm:w-[140px] lg:w-[160px] shrink-0">
      <Image
        src={src}
        alt={alt}
        fill
